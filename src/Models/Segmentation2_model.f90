...
implicit none
Private
public :: Segmentation2_GetParNumber, Segmentation2_Apply, Segmentation2_XtraRead
Contains
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
pure subroutine Segmentation2_GetParNumber(nS,npar,err,mess)
!^**********************************************************************
...
err=0;mess=''
npar= nS + nS-1
end subroutine Segmentation2_GetParNumber

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine Segmentation2_Apply(time,nS,tmin,nmin,theta,option,Y,feas,err,mess)
!^**********************************************************************
!^* Purpose: apply the
!^**********************************************************************
!^* Programmer: Ben Renard & Matteo Darienzo, Irstea Lyon
...
character(*),intent(out)::mess
!locals
character(250),parameter::procname='Segmentation2_Apply'
...
end subroutine Segmentation2_Apply

!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
subroutine Segmentation2_XtraRead(file,xtra,err,mess)
!^**********************************************************************
...
if(err/=0) then;mess=trim(procname)//':problem reading file '//trim(file);return;endif
close(unt)
end subroutine Segmentation2_XtraRead
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
end module Segmentation2_model
